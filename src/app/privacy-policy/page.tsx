...
const PrivacyPolicy = () => {
  return (
    <div className="bg-white-400 p-6 text-gray-900 sm:p-12">
      <div className="mx-auto max-w-3xl">
        <h1 className="mb-8 text-center text-3xl font-semibold">
          Privacy Policy
        </h1>
        <p className="mb-6 text-lg text-gray-700">
          This privacy policy sets out how Humminglow Aesthetics Lounge uses and
          protects any information that you give Humminglow Aesthetics Lounge
          when you use this website. Humminglow Aesthetics Lounge is committed
          ...
          accordance with this privacy statement. Humminglow Aesthetics Lounge
          ...
          with any changes. This policy is effective from December 1, 2024.
        </p>
        ...
        <ul className="mb-6 list-inside list-disc">
          ...
          <li>
            ...
            by writing to or emailing us at humminglow.aesthetics@gmail.com.
          </li>
        </ul>
        ...
        <p className="mb-6 text-lg text-gray-700">
          ...
          to humminglow.aesthetics@gmail.com.
        </p>
